...
import type { DocumentLoaderOptions, RemoteDocument } from "./docloader.ts";

const logger = getLogger(["vocab", "runtime", "mockdocloader"]);
 ...
 *
 * This is made for testing docloader
 */
